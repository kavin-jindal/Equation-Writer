...
slash = Button(frame, text='/', padx=33, pady=22, fg='black', bg='white', command=slash_cmd, borderwidth=borderwidth, font=font)
...
backspace = Button(frame, text='Space', padx=55, pady=pady, fg='white', bg='green', command=backspace_cmd, borderwidth=borderwidth, font=font )
...
backspace.grid(row=2, column=5,columnspan=6)
